...
(let ((base00 "#2b303b")
  ...
  (custom-theme-set-faces
   ...
   `(company-tooltip ((t (:foreground ,base05 :background ,base01))))
   `(company-tooltip-selection ((t (:foreground ,base07 :background ,base03))))
   `(company-tooltip-mouse ((t (:foreground ,base06 :background ,base03))))
   `(company-tooltip-common ((t (:foreground ,base05 :background ,base01))))
   `(company-tooltip-common-selection ((t (:foreground ,base0A :background ,base03))))
   `(company-tooltip-annotation ((t (:foreground ,base07 :background ,base01 :italic t))))
   `(company-scrollbar-fg ((t (:background ,base04))))
   `(company-scrollbar-bg ((t (:background ,base02))))
   `(company-preview ((t (:foreground ,base03 :foreground ,base07))))
   `(company-preview-common ((t (:foreground ,base03 :foreground ,base07))))
   `(company-preview-search ((t (:foreground ,base03 :foreground ,base07))))
   `(company-echo ((t nil)))
   `(company-echo-common ((t (,base0E))))
